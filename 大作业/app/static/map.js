...
var displayData= function(data){
            ...
            for (let i = 0; i < data.length; i++) 
            {
                ...
                add_simple_infowindow_on_map(map,vpoint,width,height,title,data[i].content,data[i].digest);                            
            } 
        }
        $.ajax({
            url: "/JSON",
...
function add_simple_infowindow_on_map(map,my_point,win_width,win_height,title_text,content_text,authorname) {
